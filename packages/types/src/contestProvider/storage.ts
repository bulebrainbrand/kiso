...
export type FileReadError = { type: "read_error"; message: string; code: string | undefined };

export type FileWriteError = { type: "write_error"; message: string; code: string | undefined };
